...
// WeatherCard component (logic kept as requested)
...
export default function ChatView() {
  const { selectedChatId, selectedChatTitle } = useChatContext();
  ...
  return (
    <div className="flex flex-col h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 antialiased relative overflow-hidden">
      {/* Background Decor */}
        ...
        <div className="w-full px-8 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="font-bold text-sm tracking-tight text-zinc-800 dark:text-zinc-100 capitalize">
                {selectedChatTitle}
              </h1>
      ...
      <main ref={scrollRef} className="flex-1 overflow-y-auto scrollbar-none relative">
        <div className="max-w-3xl mx-auto px-8 py-10 min-h-full flex flex-col">
          {messages.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 py-20">
              ...
              <div className="space-y-3">
                ...
                <p className="text-zinc-500 dark:text-zinc-400 max-w-sm mx-auto text-sm leading-relaxed text-zinc-400">
              ...
              {messages.map((message) => (
                ...
                >
                  <div className={`flex flex-col max-w-[85%] ${message.role === 'user' ? 'items-end' : 'items-start'}`}>
                    <div className={`relative px-5 py-3.5 rounded-2xl ${message.role === 'user'
      ...
      {/* Input Area */}
      <div className="p-8 bg-linear-to-t from-zinc-50 via-zinc-50 to-transparent dark:from-zinc-950 dark:via-zinc-950 sticky bottom-0 z-30">
        <form
